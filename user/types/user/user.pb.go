...
var file_user_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x64, 0x65, 0x72, 0x32, 0x90, 0x01, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x25,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x31, 0x0a, 0x08, 0x53, 0x61, 0x76, 0x65, 0x55, 0x73, 0x65,
...
var file_user_proto_depIdxs = []int32{
	...
	3, // 2: user.User.SaveUser:input_type -> user.UserRequest
	1, // 3: user.User.Ping:output_type -> user.Response
	4, // 4: user.User.getUser:output_type -> user.UserResponse
	4, // 5: user.User.SaveUser:output_type -> user.UserResponse
